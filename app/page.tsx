...
export default function Splash() {
  ...
  useEffect(() => {
    const t = setTimeout(() => router.push("/onboarding"), 2100);
    ...
    <div className="relative min-h-[100dvh] w-full overflow-hidden bg-bg fade-in py-20 lg:py-24">
      <div className="flex-1 flex flex-col items-center justify-center w-full relative">
        ...
        <div
          ...
          style={{ ["--r" as never]: "10deg", transform: "rotate(10deg)", animationDelay: "1s" }}
        >
          ₦68k
        </div>

        <div className="text-center relative z-10">
          <div className="text-3xl font-extrabold text-brand tracking-[-0.05em] leading-none">
            PIC
          </div>
          <div className="text-[16px] font-bold tracking-[0.22em] uppercase text-text-subtle mt-3">
            Price Intelligence
          </div>
        </div>
      </div>
